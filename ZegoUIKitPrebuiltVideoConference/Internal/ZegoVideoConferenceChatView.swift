//
//  ZegoVideoConferenceChatView.swift
//  ZegoPrebuiltVideoConferenceDemo
//
//  Created by zego on 2022/10/8.
//
...
class ZegoVideoConferenceChatView: UIView {
    
    weak var delegate: ZegoVideoConferenceChatViewDelegate?
...
class ZegoVideoConferenceChatView_Help: NSObject, ZegoInRoomChatViewDelegate {
    ...
    func getChatViewForHeaderInSection(_ tableView: UITableView, section: Int) -> UIView? {
        ...
        closeButton.setImage(ZegoUIKitVideoConferenceIconSetType.icon_back.load(), for: .normal)
