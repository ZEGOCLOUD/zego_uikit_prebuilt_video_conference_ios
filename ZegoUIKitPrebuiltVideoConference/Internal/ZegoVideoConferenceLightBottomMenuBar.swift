...
extension ZegoVideoConferenceLightBottomMenuBarDelegate {
    func onMenuBarMoreButtonClick(_ buttonList: [UIView]) { }
    func onLeaveVideoConference(_ isLeave: Bool){ }
}

class ZegoVideoConferenceLightBottomMenuBar: UIView {
    ...
    public weak var delegate: ZegoVideoConferenceLightBottomMenuBarDelegate?
...
extension ZegoVideoConferenceLightBottomMenuBar: LeaveButtonDelegate {
